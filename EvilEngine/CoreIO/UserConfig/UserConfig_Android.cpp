 ...
 * File        : UserConfig_Android
 *
 * Description : Save/Load code for the Android implementation of the user config system. On the
 *               Android platform all user config entries are stored in files that are on internal
 *               storage space.
 *
