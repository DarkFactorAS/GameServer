...
if not "%DF_EXTERNALLIBS%" == "" (
  ...
  set LINKER=VS2015
  set INCLUDEDIR=%DF_EXTERNALLIBS%\mysql\mysql-connector-1.1.3\include;%DF_EXTERNALLIBS%\boost-1.59.0\include\;%DF_EXTERNALLIBS%\zlib-1.2.5;%DF_EXTERNALLIBS%\openssl-1.0.0.e\include
  set PREPROCESSOR=CLIENT;WIN32;_CONSOLE;BOOST_ALL_NO_LIB;DATABASE;CPPDBC_PUBLIC_FUNC;USE_OPENSSL

  Start "EvilEngine Unittest" Windows\EvilEngineUnitTest.sln
