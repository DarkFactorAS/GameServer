...
if not "%DF_EXTERNALLIBS%" == "" (
  ...
  set PREPROCESSOR=SERVER;WIN32;_CONSOLE;BOOST_ALL_NO_LIB;CPPDBC_PUBLIC_FUNC;USE_OPENSSL

  Start "Unity B.E.E.R. Server Unittest" Server\Windows_Unittest\UnityBeerServerUnittests.sln
